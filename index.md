...
|--------|----------------|--------------------------------------|-------------|----------------|------------------------------|
|A1      |Ace             |Injection – TAs send simple text based data as part of a command or query that exploits the syntax rules of the targeted system’s interpreter. Many DC teams continue to allow the use of unsafe APIs and are lax in reviewing legacy code for injection flaws, keeping data separate from commands and limiting SQL injection mass disclosures. 
                                                                 |C3      |3       |<strong>Secure Database Access</strong> - Untrusted data and input is properly controlled and handled by database and platform authentication and communication controls.|
